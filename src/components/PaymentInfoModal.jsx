...
const PaymentInfoModal = ({ 
  ...
  // No prevenir scroll - remover este efecto completamente
  // useEffect removido para permitir scroll natural
  ...
  return (
    <Dialog size="xl" open={isOpen} onClose={onClose}>
      ...
      <div className="overflow-y-auto max-h-[100vh] sm:max-h-[90vh]" style={{ WebkitOverflowScrolling: 'touch' }}>
